...
//   - avec un dialogue de saisie de parametre
  ...
  function blk_draw(sz,orig,orient,label)
    ...
    if orient then  
      ...
      xset('color',0)  
      xfpolys(orig(1)+[0.65;0.62;0.58;0.65]*sz(1),orig(2)+[0.0833333;0.2; ...
		    0.1333333;0.0833333]*sz(2),2)
    else  
      xpolys(orig(1)+[0.55,0.55,0.35,0.55,0.35,0;0.55,1,0.55,0.35,0,0.35]* ...
	     sz(1),orig(2)+[0.8333333,0.5,0.9166667,0.4166667,0.0833333,0.9166667;0.1666667,0.5,0.5833333,0.0833333,0.0833333,0.9166667]*sz(2),[1,1,1,1,1,1])  
      xset('color',0)  
      xfpolys(orig(1)+[0.35;0.38;0.42;0.35]*sz(1),orig(2)+[0.0833333;0.2; ...
		    0.1333333;0.0833333]*sz(2),2)
    end
  endfunction 
  ...
  select job
   ...
   case 'define' then      
    ...
    x=standard_define([2,1.2],model,exprs,list(gr_i,0),'NPN');
