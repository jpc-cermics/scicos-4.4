...
//   - avec un dialogue de saisie de parametre
  ...
  select job
   ...
   case 'define' then      
    ...
    exprs="1"
    gr_i=["";"if orient then";"  xset(''thickness'',2)";"  xarcs([orig(1)+0.4*sz(1); orig(2)+0.6*sz(2);0.2*sz(1);0.2*sz(2);0;23040],2)";"  xpolys(orig(1)+[0,0.6,0.5,0.28,0.23,0.6;0.4,1,0.5,0.28,0.33,0.7]*sz(1),orig(2)+[0.5,0.5,0.4,0.74,0.69,0.22;0.5,0.5,0,0.64,0.69,0.22]*sz(2),[3,3,3,3,3,3])";"  xset(''color'',2)";"  xfpolys(orig(1)+[0.39,0.5,0.85;0.28,0.46,0.74;0.28,0.54,0.74;0.39,0.5,0.85]*sz(1),orig(2)+[0.5,0.39,0.5;0.54,0.28,0.54;0.46,0.28,0.46;0.5,0.39,0.5]*sz(2),[1,1,1])";"  xpolys(orig(1)+[0.53;0.44;0.52;0.45;0.54]*sz(1),orig(2)+[0.56;0.56;0.5;0.44;0.44]*sz(2),3)";"else";"  xset(''thickness'',2)";"  xarcs([orig(1)+0.4*sz(1); orig(2)+0.6*sz(2);0.2*sz(1);0.2*sz(2);0;23040],2)";"  xpolys(orig(1)+[1,0.4,0.5,0.72,0.77,0.4;0.6,0,0.5,0.72,0.67,0.3]*sz(1),orig(2)+[0.5,0.5,0.4,0.74,0.69,0.22;0.5,0.5,0,0.64,0.69,0.22]*sz(2),[3,3,3,3,3,3])";"  xset(''color'',2)";"  xfpolys(orig(1)+[0.61,0.5,0.15;0.72,0.54,0.26;0.72,0.46,0.26;0.61,0.5,0.15]*sz(1),orig(2)+[0.5,0.39,0.5;0.54,0.28,0.54;0.46,0.28,0.46;0.5,0.39,0.5]*sz(2),[1,1,1])";"  xpolys(orig(1)+[0.47;0.56;0.48;0.55;0.46]*sz(1),orig(2)+[0.56;0.56;0.5;0.44;0.44]*sz(2),3)";"end"]
    model.blocktype='c'                              
    model.dep_ut=[%f %t]                               
    mo.model=ModelName                                 
    model.equations=mo                                 
