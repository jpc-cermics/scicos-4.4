...
void matz_pinv (scicos_block * block, int flag)
{
  ...
  /* Terminaison */
      ...
      for (i = 0; i < (mu * nu); i++)
	{
      ...
      C2F (zgesvd) ("A", "A", &mu, &nu, (doubleC *) ptr->LA, &mu, ptr->LSV,
      ...
      if (info != 0)
	{
      ...
      *(ptr->l0) = 0;
      C2F (dlaset) ("F", &nu, &mu, ptr->l0, ptr->l0, ptr->LSi, &nu, 1);
      C2F (dlaset) ("F", &nu, &mu, ptr->l0, ptr->l0, ptr->LSr, &nu, 1);
      ...
      for (j = 0; j < mu; j++)
	{
      ...
      nsp_calpack_wmmul (ptr->LVr, ptr->LVi, &nu, ptr->LSr, ptr->LSi, &nu,
			 ptr->LCr, ptr->LCi, &nu, &nu, &nu, &mu);
      nsp_calpack_wmmul (ptr->LCr, ptr->LCi, &nu, ptr->LUr, ptr->LUi, &mu, yr,
			 yi, &nu, &nu, &mu, &mu);
    }
}
