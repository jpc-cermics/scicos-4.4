/* psi.f -- translated by f2c (version 19961017).
 *
 *
 */
...
double nsp_calpack_psi (double *xx)
{
  /* Initialized data */

  static double zero = 0.;
  static double xmax1 = 4.5e15;
  static double xsmall = 5.8e-9;
  static double xlarge = 2.71e14;
  static double x01 = 187.;
  static double x01d = 128.;
  static double x02 = 6.9464496836234126266e-4;
  static double p1[9] =
    { .004510468124576293416, 5.4932855833000385356, 376.46693175929276856,
    7952.5490849151998065, 71451.59581895193321, 306559.76301987365674,
    636069.97788964458797,
    580413.12783537569993, 165856.95029761022321
  };
  static double q1[8] =
    { 96.141654774222358525, 2628.771579058119333, 29862.49702225027792,
    162065.66091533671639, 434878.80712768329037, 542563.84537269993733,
    242421.85002017985252,
    6.4155223783576225996e-8
  };
  static double p2[7] =
    { -2.7103228277757834192, -15.166271776896121383, -19.784554148719218667,
    -8.8100958828312219821, -1.4479614616899842986, -.073689600332394549911,
    -6.5135387732718171306e-21
  };
  static double q2[6] =
    { 44.992760373789365846, 202.40955312679931159, 247.36979003315290057,
    107.42543875702278326, 17.463965060678569906, .88427520398873480342
  };
  static double fourth = .25;
  static double half = .5;
  static double one = 1.;
  static double three = 3.;
  static double four = 4.;
  static double piov4 = .78539816339744830962;
  static double xinf = 1.79e308;
  static double xmin1 = 2.23e-308;

  /* System generated locals */
  double ret_val;

  /* Builtin functions */
  double d_int (double *), tan (double), log (double);
