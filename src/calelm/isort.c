/* isort.f -- translated by f2c (version 19961017).
 *
 *
 */
...
int nsp_calpack_isort (int *count, int *n, int *index)
{
  /* System generated locals */
  int i__1, i__2, i__3;

  /* Local variables */
  int ifka, mark[50], i__, j, k, m, x, lngth, mloop, k1, la, if__, av, ip, is,
    iy, intest, is1, ifk, int__;

  /* 
   *!purpose 
   *    isort sort int array,maintaining an index array 
   * 
   *!calling sequence 
