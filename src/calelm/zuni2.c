/* zuni2.f -- translated by f2c (version 19961017).
 *
 *
 */
 ...
 */
int
nsp_calpack_zuni2 (double *zr, double *zi, double *fnu, int *kode, int *n,
...
L10:
   ...
   */
  fn = Max (*fnu, 1.);
  nsp_calpack_zunhj (&znr, &zni, &fn, &c__1, tol, &phir, &phii, &argr, &argi,
...
L40:
  ...
  for (i__ = 1; i__ <= i__1; ++i__)
    {
      fn = *fnu + (nd - i__);
      nsp_calpack_zunhj (&znr, &zni, &fn, &c__0, tol, &phir, &phii, &argr,
    ...
    L70:
       ...
       *----------------------------------------------------------------------- 
       */
      nsp_calpack_zairy (&argr, &argi, &c__0, &c__2, &air, &aii, &nai, &idum);
      nsp_calpack_zairy (&argr, &argi, &c__1, &c__2, &dair, &daii, &ndai,
			 &idum);
