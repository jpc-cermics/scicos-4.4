/* wacos.f -- translated by f2c (version 19961017).
 *
 *
 */
...
int nsp_calpack_wacos (double *zr, double *zi, double *ar, double *ai)
{
  /* Initialized data */
  ...
  /* Builtin functions */
  double sqrt (double), d_sign (double *, double *), acos (double),
  ...
  if (szr < 0.)
    {
      *ar = 3.1415926535897932384626433 - *ar;
    }
  if (y != 0. || szr < 0.)
    {
      *ai = -szi * *ai;
